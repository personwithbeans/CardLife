...
// Original Project: https://github.com/Mystereon/CardLife
// Orignial Author Mystereon(Github,M5Burner)
...
// void statusSys() { [NO CLUE WHAT THIS FUNCITON DOES BUT NEVER GETS CALLED]
//   M5Cardputer.update();
//   M5Cardputer.Display.setRotation(1);
//   extern const unsigned char gImage_002[];
//   M5Cardputer.Display.setTextSize(2);
